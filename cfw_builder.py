...
def patch_devicetree(ipsw_dir: str | Path, offsets: dict, work_dir: str | Path) -> bool:
    ...
    if not dt_scripts_dir.exists():
        dt_scripts_dir = Path("/home/kaffein/Desktop/W0lfSword/referenceforAI/usbliter8-fun2/work-27.0b2")
        if not dt_scripts_dir.exists():
            dt_scripts_dir = Path("/home/kaffein/Desktop/W0lfSword/referenceforAI/projects/usbliter8-fun2/work-27.0b2")
    scripts = [
